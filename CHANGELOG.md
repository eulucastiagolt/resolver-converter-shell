...
### Fixed
- Run the global CLI with Bun so the OpenTUI native renderer is available after npm installation

## [1.1.3] - 2026-08-05

### Fixed
- Initialize OpenTUI Bun runtime support before creating the native renderer
